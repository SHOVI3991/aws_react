...
const ActivateAccount = ({ router }) => {
    ...
    }, [router]); //To prevent useEffect to run infinitely, [router] is placed as a dependency
    ...
    <Layout>
        <div className="row">
            <div className="col-md-6 offset-md-3">
                ...
                <button className="btn btn-outline-warning btn-outline-block" onClick={clickSubmit}>
                    {buttonText}
                </button>
            </div>
        </div>
